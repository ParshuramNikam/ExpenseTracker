...
const BussinessExpenses = () => {
    ...
    return (
        <>
            <div>
                <h1 className='text-2xl md:text-3xl text-red-500 m-2 mb-5 font-semibold'>Bussiness Expenses : </h1>
                <div className='m-2 mb-5 md:flex justify-between'>
                    ...
                    /> */}
                        ...
                        <h3 className='whitespace-nowrap font-semibold text-xl'>Jhon Doe</h3>
                    </div>

                    {
                        !isOpen &&
                        <button className='shadow-lg md:w-auto mx-auto md:mx-0 flex justify-center items-center gap-1 bg-red-500 hover:bg-red-600 transition duration-50 delay-100 hover:delay-100" text-white px-8 py-4 md:py-2 rounded-lg'
                ...
                <div className='w-max mx-auto mb-5 flex items-center gap-3 bg-gray-200 m-2 rounded px-6 sm:px-10 p-2.5 border-gray-400'>
                    <div>
                        <svg xmlns="http://www.w3.org/2000/svg" className="text-gray-900 h-12 w-12" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}>
                            <path strokeLinecap="round" strokeLinejoin="round" d="M17 9V7a2 2 0 00-2-2H5a2 2 0 00-2 2v6a2 2 0 002 2h2m2 4h10a2 2 0 002-2v-6a2 2 0 00-2-2H9a2 2 0 00-2 2v6a2 2 0 002 2zm7-5a2 2 0 11-4 0 2 2 0 014 0z" />
                        </svg>
                    </div>
                    <div>
                        <div className='font-semibold text-gray-800'>Your Expense Today</div>
                        <div className='text-xl font-semibold'>20,000 &#8377;</div>
                    </div>
