  ...
  return (
    <>
      <div className='bg-gray-100 min-h-screen'>
        <h1 className='text-2xl md:text-3xl text-black  pt-3 ml-3 mb-0 font-bold'>Room Rents Expenses</h1>
        <div className='m-2 mb-5 md:flex justify-between'>
          <div className='flex md:w-max items-center gap-1.5 my-4'>
            ...
            <h3 className='whitespace-nowrap text-emerald-500 font-semibold  text-xl'>Jhon Doe</h3>
          </div>

          {
            !isOpen &&
            <div className='mt-2 '>
              <button className='shadow-lg md:w-auto mx-auto md:mx-0 flex justify-center items-center gap-1 bg-emerald-500 hover:bg-gray-600 transition duration-50 delay-100 hover:delay-100" text-white px-4 py-4 md:py-2 rounded-lg'
        ...
        <div className={`${!isOpen && 'hidden'} transition delay-150 duration-300 ease-in-out  my-4 mx-2`}>
          <h3 className='text-center text-lg text-emerald-500 font-semibold'>Add new expense</h3>
          <form className="border-2 shadow-md border-emerald-500 rounded-lg mt-1 p-2">
            ...
            <div className="flex">
              <button type='button'
                onClick={() => alert("Code requiemerald!")}
