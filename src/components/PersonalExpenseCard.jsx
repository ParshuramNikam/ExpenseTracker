    ...
    return (
        <div>
            <div className='md:flex justify-between gap-3 m-2 rounded-md shadow-md bg-red-500 text-white px-4 py-3'>
                <div>
                    <div className=''>Lorem ipsum dolor sit amet! Lorem ipsum dolor sit amet consectetur adipisicing elit. Earum voluptatem porro perferendis, corporis obcaecati at sequi sapiente nesciunt mollitia quae.</div>
